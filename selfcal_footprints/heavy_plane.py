...
class NoPlaneFootprint(EuclidOverlapFootprint):
    def return_maps(
        self,
        ...
        dusty_plane_ratios={"u": 0.32, "g": 0.4, "r": 1.0, "i": 1.0, "z": 0.9, "y": 0.9},
...
def main(args):
    ...
    sky = NoPlaneFootprint(nside=nside, smc_radius=4, lmc_radius=6)
