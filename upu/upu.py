...
class OnlyEarlyBasisFunction(bf.BaseBasisFunction):
    """Don't observe after a certain night
    ...
    """
    def __init__(self, night_max=365):
        super(OnlyEarlyBasisFunction, self).__init__()
...
def generate_blobs(
    ...
    for filtername, filtername2 in zip(filter1s, filter2s):
        ...
        if year1_limit:
            bfs.append((OnlyEarlyBasisFunction(), 0.0))
...
def main(args):
    ...
    blobs_u_yr1 = generate_blobs(nside, filter1s=['u'], filter2s=['u'],
                                 footprints=footprints,
                                 mjd_start=conditions.mjd_start,
    ...
    surveys = [ddfs, long_gaps, blobs_u_yr1 + blobs, twi_blobs, neo, greedy]
