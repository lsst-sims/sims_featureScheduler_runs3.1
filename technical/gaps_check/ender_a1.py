...
class SolarElongMaskBasisFunction(rubin_sim.scheduler.basis_functions.BaseBasisFunction):
    """Mask regions beyond some solar elongation
    ...
    """
    def __init__(self, elong_limit=45., nside=32):
...
class NObsPerYearBasisFunction(rubin_sim.scheduler.basis_functions.BaseBasisFunction):
    ...
    def __init__(
        ...
        self.survey_features["last_n_mjds"] = rubin_sim.scheduler.features.LastNObsTimes(
...
def blob_for_long(
    ...
    u_template_weight=24.,
    g_template_weight=24.,
    footprints=None,
    u_nexp1=True,
...
def generate_twilight_neo(
    ...
    for filtername in filters:
        ...
        bfs.append((SolarElongMaskBasisFunction(elong_limit=elong_limit), 0))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--utw", type=float, default=50.)
    parser.add_argument("--gtw", type=float, default=50.)
    parser.add_argument("--neo_am", type=float, default=2.5)
    parser.add_argument("--neo_elong_req", type=float, default=45.)
    parser.add_argument("--neo_area_req", type=float, default=0.)
