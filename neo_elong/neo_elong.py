...
class SolarElongMaskBasisFunction(bf.BaseBasisFunction):
...
def main(args):
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + "_"
    file_end = "amm%.1f_%i_%i_" % (neo_am, neo_area_req, neo_elong_req) + "v3.1_"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--neo_area_req", type=float, default=200.)
